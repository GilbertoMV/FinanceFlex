...
$pdf->setXY(60,20);
$pdf->Cell(100,8,'DETALLES DEL PRÉSTAMO',0,0,'C',0);
...
$pdf->SetY(70); 
$pdf->setX(10);
$pdf->Cell(140,8,'Número de cuenta: '.$prestamos['numCta'],'B',0,'L',0);
$pdf->SetY(80); 
$pdf->setX(10);
$pdf->Cell(140,8,'Teléfono: '.$res['telefono'],'B',0,'L',0);
...
$pdf->SetDrawColor(68,114,196);
$pdf->SetTextColor(68,114,196);
$pdf->Cell(140,8,'DATOS DEL PRÉSTAMO','B',0,'C',0);
$pdf->SetY(110); 
$pdf->setX(10);
$pdf->SetDrawColor(89,89,89);
$pdf->SetTextColor(89,89,89);
...
$pdf->SetY(120); 
$pdf->setX(10);
$pdf->Cell(140,8,'Fecha de Término: '.$prestamos['fechaTermino'],'B',0,'L',0);
$pdf->SetY(130); 
$pdf->setX(10);
$pdf->Cell(140,8,'Interés: '.$prestamos['interes'].'%','B',0,'L',0);
$pdf->SetY(140); 
$pdf->setX(10);
...
$pdf->Ln(7.8);
$pdf->SetY(180); 
$pdf->Cell(190,10,'TABLA DE AMORTIZACIÓN','B',0,'C',0);
$pdf->SetDrawColor(89,89,89);
$pdf->SetTextColor(89,89,89);
$pdf->SetY(190); 
$pdf->setX(10);
...
$pdf->Cell(31,10,'Interés','B',0,'C',0);
