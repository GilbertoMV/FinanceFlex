    ...
    <div class="container-n">
        <section class="nosotros" id="acerca">
            ...
            <section class="hacer">
                <div class="bloque">
                    <div class="item">
                        <img class="bloque__imagen" src="./public/img/money.png" alt="">
                        <h1> Administación</h1>
                ...
                <div class="col-1-item">
                    <div class="item">
                        <img class="bloque__imagen" src="./public/img/deposit.png" alt="">
                        <h1> Depositos</h1>
                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
                    </div>
                </div>
                <div class="col-1-item">
                    <div class="item">
                        <img class="bloque__imagen" src="./public/img/fees.png" alt="">
                        <h1> Transacciones</h1>
                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
                    </div>
                </div>
                <div class="col-1-item">
                    <div class="item">
                        <img class="bloque__imagen" src="./public/img/growth.png" alt="">
                        <h1> Prestamos</h1>
                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
                    </div>
                </div>
